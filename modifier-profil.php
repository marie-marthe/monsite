...
// Fichier PHP contenant la connexion � votre BDD
...
<html lang="fr">
    ...
    <body>      
        ...
        <form method="post">
            ...
            ?>
            <input type="text" placeholder="Votre pr�nom" name="prenom" value="<?php if(isset($prenom)){ echo $prenom; }else{ echo $afficher_profil['prenom'];}?>" required>   
